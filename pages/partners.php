...
<head>
    ...
    <link rel="stylesheet" href="css/partners.css?v=<?= $version ?>">
    ...
    <link rel="stylesheet" href="query/partners-query.css?v=<?= $version ?>">
                        ...
                        <a href="https://www.koupelny-popelka.cz/" target="_blank">
                            <div class="text_section box_glass_effect">
                                <div class="wrapper">
                                    ...
                                    <h2 class="title">Koupelny Popelka</h2>
                                </div>
                            </div>
                        </a>
                    </section>
                        ...
                        <a href="https://www.nakoledetem.cz/" target="_blank">
                            <div class="text_section box_glass_effect">
                                <div class="wrapper">
                                    ...
                                    <h2 class="title">Na kole dětem</h2>
                                </div>
                            </div>
                        </a>
                    </section>
                        ...
                        <a href="https://www.stavbyremina.cz/" target="_blank">
                            <div class="text_section box_glass_effect">
                                <div class="wrapper">
                                    ...
                                    <h2 class="title">Stavby Remina</h2>
                                </div>
                            </div>
                        </a>
                    </section>
                        ...
                        <a href="https://www.vanto.cz/" target="_blank">
                            <div class="text_section box_glass_effect">
                                <div class="wrapper">
                                    ...
                                    <h2 class="title">Stavby Vanto</h2>
                                </div>
                            </div>
                        </a>
                    </section>
                        ...
                        <a href="https://www.veseli-nad-moravou.cz/" target="_blank">
                            <div class="text_section box_glass_effect">
                                <div class="wrapper">
                                    ...
                                    <h2 class="title">Veselí nad Moravou</h2>
                                </div>
                            </div>
                        </a>
                    </section>
