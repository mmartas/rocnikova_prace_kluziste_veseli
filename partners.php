            ...
            <section class="introduction one_container">
                <section class="one_section">
                    <div class="text_section box_glass_effect one_section_left_side">
                        <h1 class="title"><span class="underline_color_gradient">Hlavní partneři</span><br> kluziště v centru <br><span class="text_color_gradient">veselí nad moravou!</span></h1>
                    </div>
